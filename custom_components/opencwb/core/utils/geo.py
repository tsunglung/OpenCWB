...
class MultiPoint(Geometry):
    ...
    def from_dict(cls, the_dict):
        ...
        :param the_dict: the geoJSON dict
        :return: `pyocwb.utils.geo.MultiPoint` instance
        """
        geom = geojson.loads(json.dumps(the_dict))
...
class Polygon(Geometry):
    ...
    def from_dict(cls, the_dict):
        ...
        :param the_dict: the geoJSON dict
        :return: `pyocwb.utils.geo.Polygon` instance
        """
        geom = geojson.loads(json.dumps(the_dict))
    ...
    def from_points(cls, list_of_lists):
        ...
        `pyocwb.utils.geo.Point` instances
...
class MultiPolygon(Geometry):
    ...
    `pyocwb.utils.geo.Point` documentation for details
    ...
    def from_dict(cls, the_dict):
        ...
        :param the_dict: the geoJSON dict
        :return: `pyocwb.utils.geo.MultiPolygon` instance
        """
        geom = geojson.loads(json.dumps(the_dict))
        result = MultiPolygon([
            [[[0, 0], [0, 0]]],
    ...
    def from_polygons(cls, iterable_of_polygons):
        ...
        :param iterable_of_polygons: list of `pyocwb.utils.geo.Point` instances
...
class GeometryBuilder:
    ...
    def build(cls, the_dict):
        """
        Builds a `pyocwb.utils.geo.Geometry` subtype based on the geoJSON geometry type specified on the input dictionary
        :param the_dict: a geoJSON compliant dict
        :return: a `pyocwb.utils.geo.Geometry` subtype instance
