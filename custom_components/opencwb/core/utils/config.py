...
def get_default_config():
    """Returns the default PyOCWB configuration.
...
def get_default_config_for_subscription_type(name):
    """Returns the PyOCWB configuration for a specific OCWB API Plan subscription type
...
def get_default_config_for_proxy(http_url, https_url):
    """Returns the PyOCWB configuration to be used behind a proxy server
