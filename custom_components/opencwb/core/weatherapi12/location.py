...
class Location:
    ...
    latitude and a numeric identifier assigned by the OCWB Weather API that uniquely
    spots the location in the world. Optionally, the country specification may
    be provided.

    Further reference about OCWB city IDs can be found at:
    ...
    :type lat: int/float
    :param _id: the location's OCWB city ID
    :type ID: int
    ...
    def to_geopoint(self):
        ...
        :returns: a ``pyocwb.utils.geo.Point`` instance
    ...
    def from_dict(cls, the_dict):
        ...
        name = data['locationName'] if 'locationName' in data else None
